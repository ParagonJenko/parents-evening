...
function displayTable($conn, $result)
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		$record .= "<tr>";
			...
			$record .= "</td>";
			$record .= "<td><button class='btn btn-warning fa fa-pencil-square-o my-auto' data-toggle='modal' href='#user-form-modal' value='{$row[0]}' onClick='showIndividualUser(this.value)'></button></td>";
